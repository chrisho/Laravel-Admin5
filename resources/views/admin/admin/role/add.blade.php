...
@section('content')
<form action="{{route('admin/role/add')}}" method="post" class="form-horizontal" id="form" autocomplete="off">
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <div class="box-title"><i class="fa fa-users"></i> 添加角色</div>
                ...
                <div class="box-body nopadding">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="Role" name="name" id="name" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">中文名称</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" placeholder="角色" name="display_name"  id="display_name"/>
                        </div>
                    </div>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <div class="box-header"> 
                                <label class="control-label checkbox-parnet">
                                    <input type="checkbox" data-id="{{$s->id}}" class="minimal p{{$s->id}}" />                                
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-hover table-bordered with-check table{{$s->id}}">
                                    <tbody>
                                        ...
                                        <tr>                            
                                            <td><label class="control-label"><input type="checkbox" name="menu_id[]" value="{{$c->id}}" class="minimal cc"> {{$c->name}}</label></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
